package org.forestcms.xxl.job.web.service.impl;
...
import org.forestcms.xxl.job.web.dao.XxlJobLogGlueDao;
import org.forestcms.xxl.job.web.dao.XxlJobLogReportDao;
...
public class XxlJobServiceImpl implements XxlJobService {
	...
	@Override
	public Map<String, Object> pageList(int start, int length, int triggerStatus, String jobDesc, String executorHandler, String author) {

		// page list
		List<XxlJobInfo> list = xxlJobInfoDao.pageList(start, length, triggerStatus, jobDesc, executorHandler, author);
		int list_count = xxlJobInfoDao.pageListCount(start, length, triggerStatus, jobDesc, executorHandler, author);
